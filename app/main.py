...
async def dashboard(request: Request):
    ...
    if not urls:
        urls_html = '<div class="empty-state"><div class="empty-state-icon">🔗</div><h3>No URLs yet</h3><p>Create your first short URL on the homepage!</p><a href="/" class="btn-primary">Go to Homepage</a></div>'
...
async def get_qr_code_page(short_code: str):
    ...
    <head>
        ...
        <style>
            body {{ font-family: 'Inter', sans-serif; text-align: center; padding: 50px; background: #0a0a0a; color: white; }}
    ...
    if url_data.get("password"):
        if not password:
            ...
            <head>
                ...
                <style>
                    body { font-family: 'Inter', sans-serif; background: #0a0a0a; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
